...
lang_map = {'en':'English','zh':'Chinese','ja':'Japanese','es':'Spanish','fr':'French','ko':'Korean','tl':'Tagalog','kn':'Kannada','ta':'Tamil','hi':'Hindi','te':'Telugu','it':'Italian','pl':'Polish','no':'Norwegian','lv':'Latvian','sv':'Swedish','fi':'Finnish','pt':'Portuguese','ca':'Catalan'}
